...
const Footer = () => {
  return (
    <footer className="site-footer site-footer--with-clipmask">
      <div className="site-footer__quote">"Show me the code."</div>
      <div className="site-social">
        <div className="site-social__list">
          <a
            href="https://github.com/wiliamvj/Portfolio"
      ...
      <div className="site-footer__copyright netlify">
        <a href="https://www.netlify.com/"> hosting by netlify ❤</a>
      </div>
    </footer>
  );
};
